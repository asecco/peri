        ...
        <div>
            <Modal open={modalOpen} onClose={onCloseModal} center styles={{ modal: {background: '#202F3B'}}}>
                <div className="p-4 sm:p-6 lg:p-8">
                    <div className="text-5xl text-red-400 text-center font-bold">About</div>
                    ...
                    <div className="mt-4 text-white text-2xl">
                        ...
                        <p>Throughout the development process(still ongoing) my goal has always been to create a site that is easy to use and gather information from.
                            As an avid movie/series fan myself, I want Peri to be a community for like-minded individuals to find the content they desire. I'm always open to
                        ...
                        <div className='flex justify-center gap-4'>
                            <a href='https://github.com/asecco/peri' target="_blank" rel="noreferrer"><FaGithub className='h-16 w-16 my-2 hover:text-red-400' /></a>
                            <a href='https://ko-fi.com/asecco' target="_blank" rel="noreferrer"><FaDollarSign className='h-16 w-16 my-2 hover:text-red-400' /></a>
                            <a href='mailto:asecco99@gmail.com' rel="noreferrer"><FaEnvelopeOpenText className='h-16 w-16 my-2 hover:text-red-400' /></a>
                        </div>
                    </div>
                </div>
            </Modal>
